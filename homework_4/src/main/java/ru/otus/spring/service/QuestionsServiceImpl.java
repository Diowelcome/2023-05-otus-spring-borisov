...
public class QuestionsServiceImpl implements QuestionsService {
    ...
    public QuestionsServiceImpl(QuestionsDao dao, IOService ioService, PersonService personService, ApplicationProperties properties, LocaleService localeService) {
        this.dao = dao;
    ...
    private String runQuestion(Question question) {
        ...
        String typeLocaleString = localeService.getMessage("type.answer", new String[]{""}, typeDefaultString);
    ...
    private String getScoreString(int percentScore, int maxScore) {
        ...
        String scoreString = localeService.getMessage("score", new Object[]{score, percentScore}, "Your score: {0} ( {1}% )");
        return scoreString;
    }
    ...
    private String getGreetingString(Person person, Boolean testPassed, Boolean goodResult) {
        ...
        return localeService.getMessage(greetingCode, new String[]{person.getFirstName()}, "{0}");
    }

    private String getPassedString(Boolean testPassed) {
        String passed = localeService.getMessage("passed", new String[]{""}, "Test is passed");
        String notPassed = localeService.getMessage("not.passed", new String[]{""}, "Test is not passed");
